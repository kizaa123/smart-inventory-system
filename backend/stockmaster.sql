-- SQL Script for StockMaster Inventory System (XAMPP/MySQL)
-- Use this in phpMyAdmin SQL tab or Import feature
...
-- Insert Staff
INSERT IGNORE INTO `staff` (`name`, `email`, `phone`, `position`, `department`, `image_url`) VALUES 
...
-- Insert Products
INSERT IGNORE INTO `products` (`sku`, `name`, `category_id`, `supplier_id`, `cost_price`, `sell_price`, `stock_quantity`, `low_stock_threshold`, `image_url`) VALUES 
...
('SYSTEM', 'Inventory Management System successfully migrated to XAMPP MySQL.');
